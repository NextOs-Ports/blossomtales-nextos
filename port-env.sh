...
# nxinput C6 seam (V4): the firmware SDL2 path admits the pad before announcing
# it (authority 1 = launcher get_controls line staged out of
# SDL_GAMECONTROLLERCONFIG before SDL_Init; 2 = CFW database; 3 = the
...
# execução, na pasta do jogo; é a única fonte aceita para o candidate-lock.
